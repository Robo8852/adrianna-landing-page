...
const practiceParagraphs = [
  ...
  "Judith Adrianna Naílah is a distinguished Clinical Psychotherapist (USA) with an extended background in neuropsychology and over a decade of experience bridging applied neuroscience, psychology, and spirituality. She holds an MSc in Transpersonal Psychology, Spirituality, and Consciousness (UK), along with an accreditation in psychedelic-assisted psychotherapy.",
  ...
  "Today the heart of Adrianna's practice is estrangement, reconciliation, and restoration — the complex dynamics of family rupture, forgiveness, boundaries, and the difficult path back to one another. She works from both sides of the divide: with parents grieving a child who has gone silent, and with those who had to step away in order to survive. Her foundation for this work is extensive expertise in treating Post-Traumatic Stress Disorder (PTSD) and Complex PTSD (CPTSD), because estrangement is rarely a single decision — it is the visible surface of wounds that run generations deep. She brings a psychospiritual lens to that recovery, focusing on Post-Traumatic Growth, resilience, memory reconsolidation, and psychological flexibility, so that restoration — whether of a relationship or of oneself — is built on something sturdier than hope.",
